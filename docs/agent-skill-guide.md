...
- Keep reverse-only shared behavior in `docs/sdd-reverse-process.md`.
...
- Read `docs/sdd-process.md` or `docs/sdd-reverse-process.md` before starting the step.
- Use `docs/testing.md` when deciding test ownership or test type.
